...
function () {
  ...
  _createClass(ExtensionManager, [{
    ...
    value: function keymaps(_ref) {
      ...
      return [].concat(_toConsumableArray$1(extensionKeymaps), _toConsumableArray$1(nodeMarkKeymaps)).map(function (keys) {
        return keymap(keys);
      });
    }
  }, {
    ...
    value: function inputRules(_ref2) {
      ...
      return [].concat(_toConsumableArray$1(extensionInputRules), _toConsumableArray$1(nodeMarkInputRules)).reduce(function (allInputRules, inputRules) {
        return [].concat(_toConsumableArray$1(allInputRules), _toConsumableArray$1(inputRules));
      }, []);
    }
  }, {
    key: "pasteRules",
    value: function pasteRules(_ref3) {
      ...
      return [].concat(_toConsumableArray$1(extensionPasteRules), _toConsumableArray$1(nodeMarkPasteRules)).reduce(function (allPasteRules, pasteRules) {
        return [].concat(_toConsumableArray$1(allPasteRules), _toConsumableArray$1(pasteRules));
      }, []);
    }
  }, {
    key: "commands",
    ...
    get: function get() {
      return this.extensions.filter(function (extension) {
        ...
        return [].concat(_toConsumableArray$1(allPlugins), _toConsumableArray$1(plugins));
      }, []);
    }
  }]);
...
function (_Emitter) {
  ...
  _createClass(Editor, [{
    ...
    value: function createExtensions() {
      return new ExtensionManager([].concat(_toConsumableArray$1(this.builtInExtensions), _toConsumableArray$1(this.options.extensions)), this);
    }
  }, {
    key: "createPlugins",
    ...
    value: function createState() {
      ...
      return EditorState.create({
        ...
        plugins: [].concat(_toConsumableArray$1(this.plugins), [inputRules({
          rules: this.inputRules
        })], _toConsumableArray$1(this.pasteRules), _toConsumableArray$1(this.keymaps), [keymap({
    ...
    value: function setParentComponent() {
      ...
      this.view.setProps({
        nodeViews: this.initNodeViews({
          parent: component,
          extensions: [].concat(_toConsumableArray$1(this.builtInExtensions), _toConsumableArray$1(this.options.extensions))
        })
      });
    }
  }, {
    ...
    value: function setActiveNodesAndMarks() {
      ...
      this.activeMarks = Object.entries(this.schema.marks).reduce(function (marks, _ref2) {
        ...
        return _objectSpread2({}, marks, _defineProperty({}, name, function () {
          return markIsActive(_this7.state, mark);
        }));
      }, {});
...
function coordsAtPos$1(view, pos) {
  ...
  if (node.nodeType === 3) {
    ...
    if ((!rect || rect.top === rect.bottom) && offset) {
      ...
      rect = singleRect$1(_child.nodeType === 3 ? textRange$1(_child) : _child, 1);
      side = 'right';
    }
  } else {
...
function () {
  ...
  _createClass(Menu, [{
    ...
    value: function update(view, lastState) {
      ...
      var start = coordsAtPos$1(view, from);
      var end = coordsAtPos$1(view, to, true); // The box in which the tooltip is positioned, to use as base
...
export { goToNextCell as $, chainCommands as A, exitCode as B, dist_53 as C, Doc as D, Editor as E, Fragment as F, addColumnBefore as G, addColumnAfter as H, InputRule as I, deleteColumn as J, addRowBefore as K, addRowAfter as L, Mark$1 as M, Node$2 as N, deleteRow as O, Paragraph as P, deleteTable as Q, ReplaceAroundStep as R, Slice as S, Text as T, mergeCells as U, splitCell as V, toggleHeaderColumn as W, toggleHeaderRow as X, toggleHeaderCell as Y, setCellAttr as Z, fixTables as _, EditorContent as a, columnResizing as a0, tableEditing as a1, toggleMark as a2, getMarkAttrs as a3, Step as a4, nodeEqualsType as a5, EditorFloatingMenu as b, EditorMenuBar as c, EditorMenuBubble as d, Extension as e, NodeSelection as f, Plugin as g, PluginKey as h, TextSelection as i, NodeRange as j, findWrapping as k, canSplit as l, liftTarget as m, nodeIsActive as n, lift as o, dist_5 as p, getMarkRange as q, Mapping as r, setBlockType as s, DecorationSet as t, Decoration as u, tableNodes as v, wrapIn as w, wrappingInputRule as x, textblockTypeInputRule as y, dist_20 as z };
